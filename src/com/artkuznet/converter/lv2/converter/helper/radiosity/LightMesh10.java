...
public class LightMesh10 implements LightProcessor{

    private final float intensity;

    public LightMesh10(float intensity) {
    ...
    public void process(Mesh mesh, List<Vector3D> vertices, List<Material> materials, List<LdbMaterial> ldbMaterials, int materialId) {
        ...
        RadiosityLight light = new RadiosityLight(255, 255, 200, intensity, 180, 180);
